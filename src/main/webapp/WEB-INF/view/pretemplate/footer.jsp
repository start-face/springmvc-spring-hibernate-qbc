...
<footer class="footer mt-20">
    <div class="container">
        <nav class="footer-nav">
            ...
            <a target="_blank" href="http://www.h-ui.net/copyright.shtml">隐私保护</a>
            <span class="pipe">|</span>
            <a target="_blank" href="http://www.h-ui.net/juanzeng.shtml">免责声明</a>
        </nav>
        <p>Copyright &copy;2013-2017 XX.net All Rights Reserved. <br>
            <a rel="nofollow" target="_blank" href="http://www.miitbeian.gov.cn/">京ICP备xxxxxxx号</a>
            <br>
        </p>
    </div>
</footer>
