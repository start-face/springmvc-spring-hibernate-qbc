...
<header class="navbar-wrapper">
    <div class="navbar navbar-black navbar-fixed-top">
        <div class="container cl">
            <a class="logo navbar-logo hidden-xs" href="${pageContext.request.contextPath}/aboutHui.shtml">欢迎访问</a>
            <a class="logo navbar-logo-m visible-xs" href="${pageContext.request.contextPath}/aboutHui.shtml"></a>
            ...
            <nav class="nav navbar-nav nav-collapse" role="navigation" id="Hui-navbar">
                <ul class="cl">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/user/getNewsList" target="_blank">信息管理</a>
                    </li>
                </ul>
            </nav>
...
<section class="container">
    <article class="page-404 minWP text-c">
        ...
        <p class="error-info">您可以：<a href="javascript:;" onclick="history.go(-1)" class="c-primary">&lt; 返回上一页</a><span
                class="ml-20">|</span><a href="${pageContext.request.contextPath}/" class="c-primary ml-20">去首页 &gt;</a></p>
    </article>
</section>
